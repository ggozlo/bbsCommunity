...
import ggozlo.bbsCommunity.global.dto.MemberInfoDto;
import ggozlo.bbsCommunity.global.dto.MemberJoinDto;
...
public class MemberController {
    ...
    public String join(MemberJoinDto joinDto, Model model) {
        ...
        memberService.join(modelMapper.map(joinDto, Member.class));
    ...
    public String inquireMember(@AuthenticationPrincipal Member member, Model model) {
        ...
        model.addAttribute("member",
                modelMapper.map(memberService.findById(member.getId()), MemberInfoDto.class));
